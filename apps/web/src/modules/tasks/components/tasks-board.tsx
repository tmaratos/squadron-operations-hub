...
const workCss = [
  ...
  ".work-chip--critical,.work-chip--overdue{background:#fdecec;border-color:#f5b5b5;color:#b42318}",
  "html[data-theme=dark] .work-chip--critical,html[data-theme=dark] .work-chip--overdue{background:rgba(242,87,87,.16);border-color:rgba(242,87,87,.45);color:#ff8f8f}",
  ".work-chip--high,.work-chip--soon{background:#fff4e0;border-color:#f3cf8f;color:#9a5b00}",
  "html[data-theme=dark] .work-chip--high,html[data-theme=dark] .work-chip--soon{background:rgba(245,176,65,.14);border-color:rgba(245,176,65,.4);color:#f5c26b}",
  ".work-chip--normal{color:var(--text-soft)}.work-chip--low,.work-chip--none{color:var(--muted)}",
  ".work-card{cursor:pointer}",
  ".work-tag{display:inline-flex;align-items:center;gap:4px;min-height:20px;padding:0 7px;border-radius:5px;background:#eef2f6;color:#475569;font-size:11px;font-weight:600;white-space:nowrap}",
  "html[data-theme=dark] .work-tag{background:rgba(148,163,184,.16);color:#cbd5e1}",
  ".work-tag button{all:unset;cursor:pointer;padding-left:2px;opacity:.75}.work-tag button:hover{opacity:1}",
  ".work-tag--blue{background:#e0edff;color:#1d4ed8}.work-tag--green{background:#dcfce7;color:#15803d}.work-tag--amber{background:#fef3c7;color:#a16207}.work-tag--red{background:#fee2e2;color:#b91c1c}.work-tag--purple{background:#f3e8ff;color:#7e22ce}.work-tag--teal{background:#ccfbf1;color:#0f766e}.work-tag--pink{background:#fce7f3;color:#be185d}",
  "html[data-theme=dark] .work-tag--blue{background:rgba(96,165,250,.18);color:#93c5fd}html[data-theme=dark] .work-tag--green{background:rgba(74,222,128,.16);color:#86efac}html[data-theme=dark] .work-tag--amber{background:rgba(251,191,36,.16);color:#fcd34d}html[data-theme=dark] .work-tag--red{background:rgba(248,113,113,.18);color:#fca5a5}html[data-theme=dark] .work-tag--purple{background:rgba(192,132,252,.18);color:#d8b4fe}html[data-theme=dark] .work-tag--teal{background:rgba(45,212,191,.16);color:#5eead4}html[data-theme=dark] .work-tag--pink{background:rgba(244,114,182,.16);color:#f9a8d4}",
  ...
  ".work-drawer__foot{display:flex;flex-wrap:wrap;gap:8px}.work-drawer__delete{margin-left:auto;color:#b42318}",
